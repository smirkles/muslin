...
def test_shoulder_sleeve_specialist_live_call() -> None:
    """AC #9: live call to the shoulder_sleeve specialist parses into SpecialistDiagnosis.
    ...
    result = _run_specialist("shoulder_sleeve", agent, [image_bytes])
