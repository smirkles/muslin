...
Fans out to five specialist agents (bust, waist/hip, back, shoulder/sleeve, neck/collar) concurrently,
...
# The five specialist regions run in this order
_SPECIALIST_REGIONS: list[str] = ["bust", "waist_hip", "back", "shoulder_sleeve", "neck_collar"]
...
class SpecialistDiagnosis:
    ...
    region: Literal["bust", "waist_hip", "back", "shoulder_sleeve", "neck_collar"]
...
async def run_diagnosis(
    ...
    Fans out to five specialist agents (bust, waist/hip, back, shoulder/sleeve, neck/collar) concurrently via
    ...
    """
    # Fan out five specialists concurrently
    specialist_tasks = [
    ...
    if not survivors:
        raise AllSpecialistsFailedError(
            "All five specialist agents failed — cannot produce a diagnosis"
        )
